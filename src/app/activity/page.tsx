      ...
      <div className="bg-white border border-gray-200 rounded-[6px]">
        <div className="divide-y divide-gray-100">
          {filtered.map((activity) => (
            <div key={activity.id} className="flex items-start gap-3 sm:gap-4 px-4 sm:px-5 py-4 hover:bg-gray-50/50 transition-colors">
              ...
              <span className="text-xs text-gray-400 whitespace-nowrap hidden sm:block">{activity.timestamp}</span>
            </div>
          ))}
        </div>
      </div>
